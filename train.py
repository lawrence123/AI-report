from core import convert_data_to_feature_csv,convert_data_to_feature, make_dataset, split_dataset, compute_accuracy, use_model
...
if __name__ == "__main__":    
    ...
    #讀取TXT convert_data_to_feature 格式(A Q)
    #讀取CSV convert_data_to_feature_csv 格式(id Q A)
    data_feature = convert_data_to_feature_csv(tokenizer,'QA-2021-01-10.csv')
